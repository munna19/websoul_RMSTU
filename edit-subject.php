...
$sql="update  tblsubjects set SubjectName=:subjectname,SubjectCode=:subjectcode,SubjectCredits=:subjectcredits where id=:sid";
$query = $dbh->prepare($sql);
$query->bindParam(':subjectname',$subjectname,PDO::PARAM_STR);
$query->bindParam(':subjectcode',$subjectcode,PDO::PARAM_STR);
$query->bindParam(':subjectcredits',$subjectcredits,PDO::PARAM_STR);
...
<div class="form-group">
 ...
 <input type="text" name="subjectcode" class="form-control" value="<?php echo htmlentities($result->SubjectCode);?>"  id="default" placeholder="Subject Code" required="required">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <input type="text" name="subjectcredits" value="<?php echo htmlentities($result->SubjectCredits);?>" class="form-control" id="default" placeholder="Subject Credits" required="required">
                                                        </div>
                                                    </div>
