...
<?php }?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
<input type="text" name="year" class="form-control" id="year" value="<?php echo htmlentities($result->Year)?>(<?php echo htmlentities($result->Semester)?>)" readonly>
                                                        </div>
                                                    </div>
<div class="form-group">
