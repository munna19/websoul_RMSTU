...
$sql="INSERT INTO  tblsubjects(SubjectName,SubjectCode,SubjectCredits) VALUES(:subjectname,:subjectcode,:subjectcredits)";
...
<div class="form-group">
 ...
 <input type="text" name="subjectcode" class="form-control" id="default" placeholder="Subject Code" required="required">
                                                    ...
                                                    <label for="default" class="col-sm-2 control-label">Subject Credits</label>
                                                        <div class="col-sm-10">
 <input type="text" name="subjectcredits" class="form-control" id="default" placeholder="Subject Credits" required="required">
                                                        </div>
                                                    </div>
