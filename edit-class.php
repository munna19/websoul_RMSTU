...
{
$year=$_POST['year'];
$yearnumeric=$_POST['yearnumeric']; 
$semester=$_POST['semester'];
$cid=intval($_GET['classid']);
$sql="update  tblclasses set Year=:year,yearNumeric=:yearnumeric,Semester=:semester where id=:cid ";
$query = $dbh->prepare($sql);
$query->bindParam(':year',$year,PDO::PARAM_STR);
$query->bindParam(':yearnumeric',$yearnumeric,PDO::PARAM_STR);
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- 1st,2nd etc</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Class Year in Numeric</label>
                                                        <div class="">
                                                            <input type="number" name="yearnumeric" value="<?php echo htmlentities($result->YearNumeric);?>" required="required" class="form-control" id="success">
                                                            <span class="help-block">Eg- 1,2 etc</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
