...
$sql="INSERT INTO  tblclasses(Year,YearNumeric,Semester) VALUES(:year,:yearnumeric,:semester)";
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="number" name="yearnumeric" required="required" class="form-control" id="success">
